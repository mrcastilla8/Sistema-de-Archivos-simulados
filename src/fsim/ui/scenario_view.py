...
class ScenarioView(ctk.CTkFrame):
    ...
    def __init__(self, 
        ...
        # --- MODIFICACIÓN: Definir un ancho mínimo para la columna de etiquetas ---
        config_frame.grid_columnconfigure(0, weight=0, minsize=140) # Ancho fijo para etiquetas
        config_frame.grid_columnconfigure(1, weight=1) # El resto del espacio para controles
        ...
        # --- Fila 4: Modo de Carga (Random vs Manual) ---
        ...
        # --- Fila 5: Panel Aleatorio (Seed) ---
        # MODIFICADO: Mover la etiqueta a config_frame para alinearla
        self.seed_label = ctk.CTkLabel(config_frame, text="Seed (Semilla):", **self.label_style)
        # Crear el frame solo para el Entry
        ...
        self.seed_entry.pack(fill="x", expand=True) # Usar pack dentro de este frame
        
        # --- Fila 5: Panel Manual (Tabla) ---
        self.manual_frame = ctk.CTkFrame(config_frame, fg_color="transparent")
        # No lo ponemos en el grid aquí
        self.manual_frame.grid_columnconfigure(0, weight=1)
        
        # ... (Contenido del Panel Manual sin cambios) ...
    ...
    def _on_workload_mode_change(self, mode: str):
        ...
        # MODIFICADO: Poner la etiqueta y el frame en el grid principal
        if mode == "Aleatorio (Seed)":
            # Mostrar etiqueta y frame de Seed
            ...
            # Ocultar panel Manual
            self.manual_frame.grid_forget()
        else: # Modo "Manual (Lista)"
            # Ocultar etiqueta y frame de Seed
    ...
    # --- Lógica de Tabla Interactiva (sin cambios) ---
