...
# ======================================================
#  Escenarios por defecto (listos para correr)
# ======================================================
...
# Campos requeridos por escenario
_REQUIRED_KEYS = {
    "description": str,
    "disk_size": int,
    "block_size": int,
    ...
    "access_pattern": dict,  # debe contener 'seq' y 'rand'
    "delete_rate": (int, float),
    "ops": int,
}

# ======================================================
#  Carga / Merge de escenarios externos
# ======================================================
...
def load_from_json(path: str | Path) -> Dict[str, Dict[str, Any]]:
    ...
    # Validación superficial (validación profunda se hace al pedir get_config)
...
def _validate_schema(name: str, cfg: Dict[str, Any]) -> None:
    ...
    # Rango de tamaños de archivo (en bloques)
    ...
    # access_pattern con normalización
...
def get_config(
    ...
    # overrides pueden definir completamente un escenario ad-hoc (sin nombre)
    if overrides:
